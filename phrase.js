...
var vowels = function () 
{
    ...
    {
      if(stringEntry.charAt(intCount) === "A" || stringEntry.charAt(intCount) === "I" || stringEntry.charAt(intCount) === "E" || stringEntry.charAt(intCount) === "O" || stringEntry.charAt(intCount) === "U"
      {
        intVowels++;
      }
    }
